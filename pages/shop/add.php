...
<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label for="productName"><span style="color:red;">*</span> Product Name</label>
                    <input type="text" id="productName" class="form-control" name="productName" required maxlength="100">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                <label for="productavailable"><span style="color:red;">*</span> Status</label>
                    <select class="form-control custom-select" name="productavailable" id="productavailable" required>
                ...
                <div class="form-group">
                <label for="productCategories"><span style="color:red;">*</span> Categories ( <a href="javascript:void(0)" onClick="getwidget('pages/shop/categories.php')">Click here to manage categories</a> )</label>
                    <select class="select2" required id="productCategories" name="productCategories" multiple="multiple" data-placeholder="Select categories" style="width: 100%;">
                    <?php 
              ...
              <div class="form-group">
                <label for="featured"><span style="color:red;">*</span> Set this as featured item ?</label>
                    <select class="form-control custom-select" name="featured" id="featured" required>
                    <option selected="" disabled="">Select one</option>
            ...
            <div class="card-body">
                <div class="form-group clearfix">
                    ...
                    <div class="input-group">
                        ...
                        <input id="BPrice" name="BPrice" type="text" class="form-control" required>
                    </div>
                </div>
                <div class="form-group clearfix">
                ...
                <div class="row" id="reduction" style="display:none;">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input id="RPrice" name="RPrice" type="text" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
                                <i class="fas fa-percentage"></i>&nbsp;&nbsp;<input type="checkbox" id="chkbxc" onClick="addPerc(this)">
                                </div>
                            </div>
                            <input id="D_Val" name="D_Val" type="text" class="form-control">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
                                    <curency><?php echo $info['Curency']; ?></curency>
                                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input id="Stock" name="Stock" placeholder="" type="text" required class="form-control">
                </div>
                <div class="form-group">
                    <label for="Stock">Aquisition price</label>
                    <input id="APrice" name="APrice" type="text" class="form-control" required>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-3">
        <div class="card">
            ...
            <input type="hidden" id="picsA" name="picsA">
...
$("#product_add").submit(function(event){
    ...
    var values = $("#product_add").serialize();
    $.ajax({
...
$("#addproduct").on("click",function(){$("#product_add").submit();});
$("#isOnSale").change(function(){
    var isChecked = $("#isOnSale").is(":checked");
    if(isChecked)
        $("#reduction").fadeIn();
    else{
        $("#reduction").fadeOut();
