...
<head>
	...
	<title>General settings :: <?php echo $globals['COMPANY']; ?></title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<base href="<?php echo $data->UpdateURIBase("/settings"); ?>">
        ...
        <div class="row mb-2">
		  ...
		  <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="javascript:void(0)" id="savechanges" class="btn btn-default btn-pill elevation-2 disabled" disabled="disabled">Save changes</a></li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<script type="module" src="dist/js/settings.js"></script>
</body>
</html>
