     ...
     <div class="container">
          <div class="row">
               <div class="col-md-12 col-sm-12">
                    <div style="display:inline-block;" editable="editable" datapanel="text"><h1>Legal Documents</h1></div>
               </div>
          ...
          <div class="row">
               ...
               <div class="col-md-offset-1 col-md-10 col-sm-12">
                    <div class="text-center">
                         ...
                         <p>
                              <?php include("core/gdpr.txt"); ?>
                         </p>
                         <h4>Terms and Conditions</h4>
                         <p>
                              <?php include("core/tos.txt"); ?>
                         </p>
                         <h4>Disclaimer</h4>
                         <p>
                              <?php include("core/dscl.txt"); ?>
                         </p>
                    </div>
                </div>
