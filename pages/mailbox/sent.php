...
$mailbox = $data->GetMailbox($user,$project,false,'sent');
?>
                  ...
                  <tr>
                    <td>
                      <div class="icheck-primary">
                        <input type="checkbox" value="<?php echo $mail['ID']; ?>" class="checkedMail">
                    ...
                    <?php }?>
                    <?php if(strlen($mail['Name']) > 15) echo substr($mail['Name'],0,13)."..."; else echo $mail['Name']; ?></td>
                    <td class="mailbox-subject">
                        <b><a href="mailbox/readmail/<?php echo $mail['ID']; ?>"><?php
...
{
    var MailsToDelete = [];
    var checkboxes = $(document).find(".checkedMail");
...
if (result.value) {
    ...
    $.ajax({
        ...
        method: "post",
        data: values,
        success: function(data){$("#mailInbox").html(data);}
    });
    }
	});
}
