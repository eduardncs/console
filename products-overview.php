        ...
        <div class="row mb-2">
		  ...
		  <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="javascript:void(0)" class="btn btn-default btn-pill elevation-2" id="settingsBtn">Change Settings</a></li>
            </ol>
          </div>
          <!-- /.col -->
        </div><!-- /.row -->
...
{
		getpage("pages/shop/overview", "E-Commence :: Overview");
		getsubpage();
})
$("#settingsBtn").on("click",function(){
	switch($(this).text())
	{
		case "Change Settings":
			getpage("pages/shop/settings", "E-Commence :: Edit shop settings");
			getsubpage();
			$(this).text("Save and go back");
		break;
