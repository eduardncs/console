...
if($project->project_type != "Blog") { header("Location:dashboard");}
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<title>Blog Overview :: <?php echo $globals['COMPANY']; ?></title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<base href="<?php $url = $data->UpdateURIBase("/overview"); $url = str_replace("/author","",$url); echo $url;  ?>">
        ...
        <div class="row mb-2">
		  ...
		  <div class="col-sm-6" id="breadcrumb">
            <ol class="breadcrumb float-sm-right">
				...
				<a href="blog/overview/author" id="setBtn" class="btn btn-default btn-pill elevation-2">Edit settings</a>
				<a href="blog/overview" id="bkBtn" class="btn btn-default btn-pill elevation-2" style="display:none;">Back</a></li>
            </ol>
          </div>
          <!-- /.col -->
        </div><!-- /.row -->
...
<script type="module" src="dist/js/blog.js"></script>
</body>
</html>
